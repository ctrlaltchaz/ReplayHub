    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add up to 10 custom links. Drag to reorder. These will appear in a collapsible section
            in the sidebar.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between pt-4 border-t">
            <AppButton variant="outline" onClick={addQuickLink} disabled={quickLinks.length >= 10}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>How your quick links will appear in the sidebar</CardDescription>
        </CardHeader>
        <CardContent>
          {quickLinks.length === 0 ? (
            ...
            <div className="space-y-2 max-w-xs">
              {quickLinks.map((link, index) => {
                const IconComponent =
                  link.icon && iconComponents[link.icon] ? iconComponents[link.icon] : Link2;
