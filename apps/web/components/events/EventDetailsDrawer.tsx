...
export function EventDetailsDrawer({
  ...
  const getStaffAvatarUrl = (avatar?: string) => {
    if (!avatar) return undefined;
    return avatar.startsWith("/") ? `${getServerUrl()}${avatar}` : avatar;
  };
  ...
  const hasProductionInfo =
    event.gameTitle || event.productionLead || event.broadcastChannel || event.graphicsPackage;
      ...
      <SheetContent className="sm:max-w-[550px] overflow-y-auto">
        ...
        <div className="space-y-6 mt-6">
                ...
                <div className="flex items-center justify-between bg-muted/50 p-3 rounded-lg">
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">
                      Click to view runsheet details
                    </div>
                  </div>
                  <Button onClick={handleViewRunsheet} size="sm" variant="outline">
                  ...
                  <div className="bg-gradient-to-br from-muted/50 to-muted/30 rounded-lg p-4 border">
                    <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="flex flex-col items-center gap-1 px-2">
                        <div className="font-montserrat font-bold text-xl text-muted-foreground">
                          VS
                        </div>
          ...
          {event.teamId && (
            <>
              <div className="space-y-3">
                ...
                <p className="text-sm">{event.teamName || "Team event"}</p>
              </div>
              <Separator />
            </>
          )}
          ...
          <div className="space-y-3 pt-4">
            ...
            <Button onClick={handleViewCalendar} variant="outline" className="w-full">
