...
async function fixedTest() {
    ...
    try {
        ...
        const loginResponse = await axios.post('http://localhost:3001/api/org/testorg/auth/login', {
        ...
        const availResponse = await axios.get('http://localhost:3001/api/org/testorg/players/availability', {
