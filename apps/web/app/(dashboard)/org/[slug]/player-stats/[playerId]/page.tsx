                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                {Object.entries(stats.gameBreakdown).map(([game, breakdown]) => (
                                    <div key={game} className="p-4 rounded-lg border bg-card space-y-3">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                                            <div className="text-center">
                                                <p className="text-sm text-muted-foreground mb-1">Kills</p>
                                                <p className="text-2xl font-bold">{breakdown.totalKills}</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="text-sm text-muted-foreground mb-1">Deaths</p>
                                                <p className="text-2xl font-bold">{breakdown.totalDeaths}</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="text-sm text-muted-foreground mb-1">Assists</p>
                                                <p className="text-2xl font-bold">{breakdown.totalAssists}</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="text-sm text-muted-foreground mb-1">KDA Ratio</p>
                                                <p className="text-2xl font-bold">{breakdown.kda}</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="text-sm text-muted-foreground mb-1">Avg Rating</p>
                                                <p className={`text-2xl font-bold ${getRatingColor(breakdown.avgRating)}`}>
                                                    {breakdown.avgRating}
                                                </p>
                                            </div>
                                            <div className="text-center">
                                                <p className="text-sm text-muted-foreground mb-1">MVPs</p>
                                                <p className="text-2xl font-bold">{breakdown.mvps}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
