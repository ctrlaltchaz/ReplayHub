-- DropForeignKey
ALTER TABLE "public"."password_audit_logs" DROP CONSTRAINT "password_audit_logs_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."password_entries" DROP CONSTRAINT "password_entries_tenant_id_fkey";
...
-- AlterTable
ALTER TABLE "event_staff_assignments" ALTER COLUMN "updated_at" DROP DEFAULT;

-- AlterTable
ALTER TABLE "live_graphics" ALTER COLUMN "updated_at" DROP DEFAULT;

-- AlterTable
ALTER TABLE "password_entries" ALTER COLUMN "updated_at" DROP DEFAULT;
...
-- RenameIndex
ALTER INDEX "discord_scheduled_notifications_tenant_id_status_next_run_at_id" RENAME TO "discord_scheduled_notifications_tenant_id_status_next_run_a_idx";
