...
export const DEFAULT_PERMISSION_DEFINITIONS: PermissionDefinition[] = [
    ...
    { key: 'achievements.create', group: 'achievements', description: 'Create achievements (legacy scope)' },
    { key: 'achievements.approve', group: 'achievements', description: 'Approve achievements (legacy scope)' },
