...
export class LineupController {
    ...
    async create(
        ...
        return this.lineupService.create(req.tenant!.id, eventId, createLineupDto);
    }
    ...
    async update(
        ...
        return this.lineupService.update(req.tenant!.id, id, updateLineupDto);
    }
    ...
    async setSlots(
        ...
        return this.lineupService.setSlots(req.tenant!.id, lineupId, slotsDto.slots, slotsDto.autoAttachMissing);
    }
    ...
    async removeSlot(
        ...
        return this.lineupService.removeSlot(req.tenant!.id, lineupId, slotId);
    }
    ...
    async publish(
        ...
        return this.lineupService.publish(req.tenant!.id, lineupId);
    }
    ...
    async delete(
        ...
        return this.lineupService.delete(req.tenant!.id, lineupId);
    }
}
