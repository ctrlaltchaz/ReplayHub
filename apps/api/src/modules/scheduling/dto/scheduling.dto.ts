...
export const createEventSchema = baseEventSchema.refine(
    ...
    data => !data.callTime || new Date(data.callTime) <= new Date(data.startAt),
    {
...
export class UpdateEventDto {
    ...
    @ApiPropertyOptional({ description: 'Event type', enum: ['Broadcast', 'Tournament', 'Showmatch', 'Rehearsal', 'Other'] })
    @IsOptional()
...
export class QueryEventsDto {
    ...
    @ApiPropertyOptional({ description: 'Filter by event type', enum: ['Broadcast', 'Tournament', 'Showmatch', 'Rehearsal', 'Other'] })
    @IsOptional()
    @IsEnum(['Broadcast', 'Tournament', 'Showmatch', 'Rehearsal', 'Other'])
    eventType?: string;
...
export class CalendarWeekQueryDto {
    ...
    @ApiPropertyOptional({
        description: 'IANA timezone identifier (e.g., "America/New_York", "Europe/London"). Defaults to tenant timezone or UTC.',
