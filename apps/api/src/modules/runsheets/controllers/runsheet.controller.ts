...
export class RunsheetController {
  ...
  async createTestFull(@Req() req: Request, @Body() createRunsheetDto: CreateRunsheetDto) {
    try {
  ...
  @Can('runsheet.edit')
  @UseGuards(PermissionGuard)
  async createTestWithGuard(@Req() req: Request, @Body() createRunsheetDto: CreateRunsheetDto) {
    return {
      success: true,
  ...
  @Post('runsheets-test')
  async createTest(@Req() req: Request, @Body() createRunsheetDto: CreateRunsheetDto) {
    return {
      success: true,
  ...
  @Can('runsheet.edit')
  @UseGuards(PermissionGuard)
  async create(@Req() req: Request, @Body() createRunsheetDto: CreateRunsheetDto) {
    try {
      if (!req.tenant?.id) {
  ...
  @Can('runsheet.view')
  @UseGuards(PermissionGuard)
  async findMany(@Req() req: Request, @Query() query: RunsheetQueryDto) {
  ...
  async update(
    ...
    return this.runsheetService.update(
      req.tenant!.id,
      id,
      updateRunsheetDto,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
  ...
  async approve(@Req() req: Request, @Param('id') id: string) {
    return this.runsheetService.approve(
      req.tenant!.id,
      id,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
      req.orgUser?.email ?? req.globalUser?.email ?? null
  ...
  @Can('runsheet.lock')
  @UseGuards(PermissionGuard)
  async lock(@Req() req: Request, @Param('id') id: string) {
    return this.runsheetService.lock(
      req.tenant!.id,
      id,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
      req.orgUser?.email ?? req.globalUser?.email ?? null
  ...
  @Can('runsheet.approve')
  @UseGuards(PermissionGuard)
  async unapprove(@Req() req: Request, @Param('id') id: string) {
    return this.runsheetService.unapprove(
      req.tenant!.id,
      id,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
      req.orgUser?.email ?? req.globalUser?.email ?? null
  ...
  async delete(@Req() req: Request, @Param('id') id: string) {
    return this.runsheetService.delete(
      req.tenant!.id,
      id,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
      req.orgUser?.email ?? req.globalUser?.email ?? null
  ...
  async duplicate(@Req() req: Request, @Param('id') id: string) {
    return this.runsheetService.duplicate(
      req.tenant!.id,
      id,
      req.globalUser!.id,
      req.globalUser?.email ?? null
    );
  }
  ...
  async addItems(
    ...
    return this.runsheetService.addItems(
      req.tenant!.id,
      runsheetId,
      itemsDto,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
  ...
  async reorderItems(
    ...
    return this.runsheetService.reorderItems(
      req.tenant!.id,
      runsheetId,
      body.itemIds,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
  ...
  async updateItem(
    ...
    return this.runsheetService.updateItem(
      req.tenant!.id,
      runsheetId,
      itemId,
      updateItemDto,
  ...
  async deleteItem(
    ...
    return this.runsheetService.deleteItem(
      req.tenant!.id,
      runsheetId,
      itemId,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
