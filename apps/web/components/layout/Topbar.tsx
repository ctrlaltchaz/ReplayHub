...
export function Topbar({ org, onMobileMenuToggle }: TopbarProps) {
    ...
    return (
        <>
            ...
            <header data-topbar="true" className="h-20 border-b bg-card flex items-center justify-between px-6 shadow-modern">
                {/* Left side */}
                <div className="flex items-center gap-6">
                    ...
                    <Link href="/" className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-bold tracking-tight font-montserrat hidden sm:block">{displayName}</h1>
                    </Link>
                ...
                <div className="flex items-center gap-6">
                    ...
                    {isAdminPage ? (
                        <Button variant="outline" size="default" className="flex items-center gap-3 px-4 py-2 font-montserrat" disabled>
                            ...
                            <>
                                ...
                                <div className="absolute right-0 mt-2 w-64 bg-card border rounded-md shadow-lg z-50 p-2">
                                    <div className="py-3 px-2 opacity-60 cursor-not-allowed">
                                        ...
                                        <span className="font-medium">{globalUser?.name || globalUser?.email || "Not logged in"}</span>
                                    </div>
