...
export class ChecklistController {
    ...
    async createTemplate(
        @Req() req: Request,
        @Body() createTemplateDto: CreateChecklistTemplateDto,
    ) {
    ...
    async updateTemplate(
        ...
        return this.checklistService.updateTemplate(req.tenant!.id, id, updateTemplateDto);
    }
    ...
    async deleteTemplate(
        ...
        return this.checklistService.deleteTemplate(req.tenant!.id, id);
    }
    ...
    async updateChecklist(
        ...
        return this.checklistService.updateChecklist(req.tenant!.id, id, updateChecklistDto);
    }
    ...
    async deleteChecklist(
        ...
        return this.checklistService.deleteChecklist(req.tenant!.id, id);
    }
