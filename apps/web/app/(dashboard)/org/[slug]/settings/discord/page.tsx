    ...
    <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription className="mt-2 space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <strong>Channel Notifications:</strong> Bot posts rich embeds to designated channels
              </li>
              <li>
                <strong>User Verification:</strong> Link Discord accounts for personalized
                notifications
              </li>
              <li>
                <strong>Direct Messages:</strong> Send DMs to users for important updates
              </li>
            </ul>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Current status of your Discord integration</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          {!config?.guildName ? (
            <Alert>
              ...
              <AlertDescription>
                Link your Discord bot first to access channel selection. See the &quot;Discord Bot
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">General announcements and updates</p>
              </div>

              <AppButton onClick={handleSaveChannels} disabled={isSaving} isLoading={isSaving}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                You need to create a Discord bot in the Discord Developer Portal and invite it to
                your server before linking. See our{" "}
                <a
                  href="/docs/discord-bot-setup"
                  className="underline"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Right-click your server in Discord and &quot;Copy Server ID&quot; (Developer Mode
                must be enabled)
              </p>
            </div>
      ...
      <ScheduledNotificationsPanel slug={slug} disabled={!config?.guildName} />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Choose which types of notifications to send to Discord</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Send notifications for roster changes</p>
            </div>
            <Switch
              id="enable-roster"
          ...
          <AppButton onClick={handleUpdateSettings} disabled={isSaving} isLoading={isSaving}>
