...
export const ORG_NAV: NavItem[] = [
    ...
    { key: 'calendar', label: 'Calendar', href: orgPath.calendar, required: PERMISSIONS.EVENTS_VIEW },
    {
        ...
        children: [
            { key: 'teams', label: 'Teams', href: orgPath.rosterTeams, required: PERMISSIONS.ROSTERS_VIEW },
            { key: 'players', label: 'Players', href: orgPath.rosterPlayers, required: PERMISSIONS.ROSTERS_VIEW },
            { key: 'lineups', label: 'Lineups', href: orgPath.rosterLineups, required: PERMISSIONS.ROSTERS_VIEW },
            { key: 'achievements', label: 'Achievements', href: orgPath.rosterAchievements, required: PERMISSIONS.ROSTERS_VIEW },
            { key: 'availability', label: 'Availability', href: orgPath.rosterAvailability, required: PERMISSIONS.ROSTERS_VIEW },
        ]
    },
    { key: 'gamelog', label: 'Game Log', href: orgPath.gamelog, required: PERMISSIONS.GAMELOG_VIEW },
    { key: 'player-stats', label: 'Player Stats', href: orgPath.playerStats, required: PERMISSIONS.ROSTERS_VIEW },
