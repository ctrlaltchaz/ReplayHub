...
export default function CategoriesPage() {
    ...
    const { data: categories, isLoading, refetch } = useDocCategories(slug);
    ...
    const orgCategories = categories?.filter((cat) => cat.organisationId !== null) || [];
    ...
    const handleEdit = async () => {
        ...
        try {
            const response = await fetch(
                getApiUrl(`/org/${slug}/docs/categories/${selectedCategory.id}`),
                {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                    credentials: 'include',
                ...
                {isLoading ? (
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Create your first category to start organizing your documentation.
                            </CardDescription>
                        </CardHeader>
                    </Card>
                ) : (
