...
const PRESET_ROLES = [
    {
        ...
        permissions: [
            ...
            'runsheet.view', 'runsheet.edit', 'runsheet.approve', 'runsheet.lock',
            'resources.view', 'resources.manage',
            'checklists.view', 'checklists.run', 'checklists.manage',
            'inventory.view', 'inventory.update', 'inventory.book',
            'assets.upload', 'assets.approve', 'assets.manage',
            'roster.view', 'roster.manage',
            'team.create', 'team.update', 'team.archive', 'team.select_lineup',
            'player.create', 'player.update', 'player.link_user',
            'players.view', 'players.edit_profile_self', 'players.edit_admin',
            'availability.manage', 'availability.set_self',
            'lineup.create', 'lineup.update', 'lineup.publish',
            'achievement.create', 'achievement.approve', 'achievements.create', 'achievements.approve',
            ...
            'users.view', 'users.read', 'users.create', 'users.update', 'users.delete',
            'invites.create', 'invites.read', 'invites.delete',
            'org.settings.view', 'org.settings.manage',
            'org.users.view', 'org.users.manage',
            'org.roles.view', 'org.roles.manage',
            'org.invites.view', 'org.invites.manage',
            'org.audit.view',
            'feedback.submit'
        ]
    },
    {
        ...
        permissions: [
            ...
            'roster.view', 'roster.manage',
            'team.create', 'team.update', 'team.select_lineup',
            'player.create', 'player.update',
            'players.view', 'players.edit_admin',
            'availability.manage', 'availability.set_self',
            'lineup.create', 'lineup.update',
            'gamelog.view',
    ...
    },
    {
        ...
        permissions: [
            ...
            'reports.view', 'reports.export',
            'achievement.create', 'achievement.approve',
            'users.view',
            'feedback.submit'
        ]
    },
    ...
    },
    {
        ...
        permissions: [
            ...
            'events.view',
            'roster.view', 'roster.manage',
            'team.update', 'team.select_lineup',
            'player.update',
            'players.view', 'players.edit_profile_self',
            'availability.manage', 'availability.set_self',
            'lineup.create', 'lineup.update',
            'gamelog.view',
            'stats.record',
    ...
    try {
        ...
        for (const roleData of PRESET_ROLES) {
            ...
            if (permissions.length === 0) {
                console.log(`⚠️  Warning: No permissions found for ${roleData.name}, skipping permission assignment`);
            } else {
                ...
                console.log(`✅ Created: ${roleData.name} (${permissions.length}/${roleData.permissions.length} permissions)`);
            }
