...
export class GameLogController {
  ...
  async createMatch(@Request() req: any, @Body() dto: CreateMatchDto): Promise<MatchResponse> {
    return this.gameLogService.createMatch(
      req.tenant.id,
      req.globalUser.id,
      dto,
      req.orgUser?.id,
  ...
  async findMatches(@Request() req: any, @Query() query: QueryMatchesDto) {
  ...
  async findMatchById(@Request() req: any, @Param('id') matchId: string): Promise<MatchResponse> {
  ...
  async updateMatch(
    ...
    return this.gameLogService.updateMatch(
      req.tenant.id,
      matchId,
      dto,
      req.orgUser?.id,
  ...
  async deleteMatch(@Request() req: any, @Param('id') matchId: string): Promise<void> {
    return this.gameLogService.deleteMatch(
      req.tenant.id,
      matchId,
      req.orgUser?.id,
      req.orgUser?.email ?? req.globalUser?.email ?? null
  ...
  async submitMatch(
    ...
    return this.gameLogService.submitMatch(
      req.tenant.id,
      matchId,
      dto.notes,
      req.orgUser?.id,
  ...
  async approveMatch(
    ...
    return this.gameLogService.approveMatch(
      req.tenant.id,
      matchId,
      dto.notes,
      dto.forceApprove,
  ...
  async unapproveMatch(
    ...
    return this.gameLogService.unapproveMatch(
      req.tenant.id,
      matchId,
      dto.reason,
      req.orgUser?.id,
  ...
  async bulkCreateMaps(
    ...
    return this.mapGameService.bulkCreateMapGames(
      req.tenant.id,
      matchId,
      dto,
      req.orgUser?.id,
  ...
  async findMapById(@Request() req: any, @Param('mapId') mapId: string): Promise<MapGameResponse> {
  ...
  async updateMap(
    ...
    return this.mapGameService.updateMapGame(
      req.tenant.id,
      mapId,
      dto,
      req.orgUser?.id,
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  async deleteMap(@Request() req: any, @Param('mapId') mapId: string): Promise<void> {
    return this.mapGameService.deleteMapGame(
      req.tenant.id,
      mapId,
      req.orgUser?.id,
      req.orgUser?.email ?? req.globalUser?.email ?? null
  ...
  async bulkCreatePlayerStats(
    ...
    return this.playerStatService.bulkCreatePlayerStats(
      req.tenant.id,
      matchId,
      dto,
      req.orgUser?.id,
  ...
  async updatePlayerStat(
    ...
    return this.playerStatService.updatePlayerStat(
      req.tenant.id,
      statId,
      dto,
      req.orgUser?.id,
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  async deletePlayerStat(@Request() req: any, @Param('statId') statId: string): Promise<void> {
    return this.playerStatService.deletePlayerStat(
      req.tenant.id,
      statId,
      req.orgUser?.id,
      req.orgUser?.email ?? req.globalUser?.email ?? null
