...
export class AssetController {
    ...
    async uploadAsset(
        ...
        return await this.assetService.uploadAsset(req.tenant!.id, file, req.orgUser!.id);
    }
    ...
    async updateAsset(
        ...
        return await this.assetService.updateAsset(req.tenant!.id, assetId, updateAssetDto);
    }
    ...
    async downloadAssetVersion(
        ...
        const downloadInfo = await this.assetService.downloadAssetVersion(req.tenant!.id, assetId, versionId);
    ...
    async deleteAsset(
        ...
        return await this.assetService.deleteAsset(req.tenant!.id, assetId);
    }
    ...
    async approveAsset(
        ...
        return await this.assetService.approveAsset(req.tenant!.id, assetId);
    }
    ...
    async rejectAsset(
        ...
        return await this.assetService.rejectAsset(req.tenant!.id, assetId);
    }
}