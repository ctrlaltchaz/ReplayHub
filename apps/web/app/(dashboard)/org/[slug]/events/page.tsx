    ...
    return (
      <div className="container mx-auto p-6">
        <Alert variant="destructive">
          ...
          <AlertDescription>You do not have permission to view events.</AlertDescription>
        </Alert>
      </div>
    );
  }
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => refetch()} disabled={isRefetching}>
                {isRefetching ? <RefreshCw className="h-4 w-4 animate-spin" /> : "Retry"}
              </Button>
            </AlertDescription>
          </Alert>
        </div>
      ...
      <div className="space-y-6">
        ...
        <EventsTable
          events={(events || []).filter((event) =>
            showCompleted ? true : event.status === "scheduled"
          )}
          isLoading={isLoading}
