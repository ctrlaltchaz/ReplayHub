...
export class InventoryController {
  ...
  async createItem(@Req() req: Request, @Body() createItemDto: CreateInventoryItemDto) {
    return await this.inventoryService.createItem(
      req.tenant!.id,
      createItemDto,
      req.orgUser?.id ?? null,
  ...
  async findItems(@Req() req: Request, @Query() query: QueryInventoryItemsDto) {
  ...
  async findItemById(@Req() req: Request, @Param('id') itemId: string) {
  ...
  async updateItem(
    ...
    return await this.inventoryService.updateItem(
      req.tenant!.id,
      itemId,
      updateItemDto,
      req.orgUser?.id ?? null,
  ...
  async deleteItem(@Req() req: Request, @Param('id') itemId: string) {
    return await this.inventoryService.deleteItem(
      req.tenant!.id,
      itemId,
      req.orgUser?.id ?? null,
      req.orgUser?.email ?? null
  ...
  async bookItem(
    ...
    return await this.inventoryService.bookItem(
      req.tenant!.id,
      itemId,
      bookDto,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
  ...
  async unbookItem(@Req() req: Request, @Param('id') itemId: string) {
    return await this.inventoryService.unbookItem(
      req.tenant!.id,
      itemId,
      req.orgUser?.id ?? req.globalUser?.id ?? null,
      req.orgUser?.email ?? req.globalUser?.email ?? null
  ...
  async createKit(@Req() req: Request, @Body() createKitDto: CreateInventoryKitDto) {
    return await this.inventoryService.createKit(
      req.tenant!.id,
      createKitDto,
      req.orgUser?.id ?? null,
      req.orgUser?.email ?? null
  ...
  async findKitById(@Req() req: Request, @Param('id') kitId: string) {
  ...
  async addItemsToKit(
    ...
    return await this.inventoryService.addItemsToKit(
      req.tenant!.id,
      kitId,
      addItemsDto,
      req.orgUser?.id ?? null,
  ...
  async findMovements(@Req() req: Request, @Query('itemId') itemId?: string) {
