...
@Module({
  ...
  providers: [TeamService, PlayerService, LineupService, AchievementService, ExportService],
  exports: [TeamService, PlayerService, LineupService, AchievementService, ExportService],
})
