...
export class TeamController {
    ...
    async create(
        ...
        return this.teamService.create(req.tenant!.id, createTeamDto);
    }
    ...
    async update(
        ...
        return this.teamService.update(req.tenant!.id, id, updateTeamDto);
    }
    ...
    async delete(
        ...
        return this.teamService.delete(req.tenant!.id, id);
    }
    ...
    async archive(
        ...
        return this.teamService.archive(req.tenant!.id, id);
    }
    ...
    async removeMember(
        ...
        return this.teamService.removeMember(req.tenant!.id, teamId, playerId);
    }
