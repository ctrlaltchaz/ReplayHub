...
} from "@/components/profile/PlayerProfileCard";
  ...
  const handleEmailChange = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response
          .json()
          .catch(() => ({ message: "Failed to send verification code" }));
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
              ...
              <div className="pt-4 border-t">
                  ...
                  {!isChangingPassword ? (
                    ...
                    <div className="space-y-2 p-3 border rounded-lg bg-muted/50">
                      ...
                      <div className="flex gap-2">
                        <Button size="sm" onClick={handlePasswordChange} className="flex-1">
                          Update
                        </Button>
                        <Button
                          size="sm"
                    ...
                    <div className="space-y-2 p-3 border rounded-lg bg-muted/50">
                      ...
                      {!emailVerificationSent ? (
                        <>
                          ...
                          />
                          <div className="flex gap-2">
                            <Button size="sm" onClick={handleEmailChange} className="flex-1">
                              Send Code
                            </Button>
                            <Button
                              size="sm"
                ...
                <div className="space-y-2">
                  <Button
                    ...
                    size="sm"
                    className="w-full justify-start"
                    onClick={() => router.push(`/org/${slug}/profile/quick-login`)}
                  >
                    <KeyRound className="h-4 w-4 mr-2" />
                    Quick Login PIN
                  </Button>
          ...
          {playerLoading ? (
            ...
            <PlayerProfileCard player={playerData} slug={slug} onUpdate={handlePlayerUpdate} />
          ) : null}
        </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg border bg-card">
                  ...
                  <div>
                    <p className="text-2xl font-bold">
                      {profile.orgUsers?.reduce(
                        (total, orgUser) => total + (orgUser.roles?.length || 0),
                        0
                      ) || 0}
                    </p>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg border bg-card">
                  ...
                  <div>
                    <p className="text-2xl font-bold">{profile.organisations?.length || 0}</p>
                  ...
                  {profile.orgUsers.map((orgUser) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-lg overflow-hidden border-2 border-border bg-muted flex items-center justify-center">
                            {(orgUser.organisation as any).branding?.logoUrl ||
                            (orgUser.organisation as any).branding?.logo ? (
                              <Image
